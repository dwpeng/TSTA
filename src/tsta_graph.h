...
define_array(tsta_node_index_t,
             tsta_node_index_array_t,
             tsta_node_index_array);
...
static inline tsta_node_t*
tsta_graph_node(tsta_graph_t* graph, tsta_node_index_t index)
{
...
static inline tsta_node_t*
tsta_graph_sort_node(tsta_graph_t* graph, size_t index)
{
  return tsta_graph_node(graph, graph->sort.data[index]);
}

static inline tsta_node_t*
tsta_graph_unsort_node(tsta_graph_t* graph, size_t index)
{
...
int tsta_msa_expand_passing_seq(tsta_graph_t* graph,
                                size_t old_count,
                                size_t new_count);
