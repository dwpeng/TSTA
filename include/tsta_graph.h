...
static inline const tsta_node_t *tsta_graph_cnode(const tsta_graph_t *graph,
                                                  tsta_node_index_t index) {
  return &graph->nodes.data[index];
}
...
static inline tsta_node_index_t tsta_graph_node_index(const tsta_graph_t *graph,
                                                      const tsta_node_t *node) {
